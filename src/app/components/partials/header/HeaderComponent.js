        ...
        return (
            <>
                <header className="flex items-center justify-between px-6 py-4 bg-[#fef6ee] shadow-md sticky top-0 z-10">
                    ...
                    <Link href="/wellcome" className="text-2xl font-bold text-black hover:underline">
                        xiomun
                    </Link>
                    ...
                    <nav className="hidden md:flex space-x-4 text-sm">
                        ...
                        <Link href="/recomendation-with-ai" className="hover:underline text-black">Recomendation With AI</Link>
